...
if __name__ == '__main__':
    ...
    recenici = [data[i][0] for i in range(len(data))]
    print(recenici)
    labeli = [data[i][1] for i in range(len(data))]
    #print(labeli)

    tf_idf, recnik_so_frekvencii_na_pojavuvanje, br_doc_vo_mnoz, zborovi_vo_mnoz = create_dataset(recenici,labeli)
    #print(tf_idf)
    #for dokumenti in recenici:
        #procesiran_dokument = process_document(dokumenti,tf_idf,br_doc_vo_mnoz,zborovi_vo_mnoz)
    #print(procesiran_dokument)
